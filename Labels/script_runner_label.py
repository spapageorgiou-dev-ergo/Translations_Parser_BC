...
def run_label_script(script_path, project_dir,txt_path):
    ...
    translations,translation_lines= module.extract_translations_from_txt(txt_path)
    # Run injection
    module.inject_translations_to_captions(translations,translation_lines,"el_GR",project_dir)
...
if __name__ == "__main__":
    ...
    base_dir = r"C:/Users/s.papageorgiou/Desktop/Useful Scripts/Parser_for_BC_Migration/Labels"
