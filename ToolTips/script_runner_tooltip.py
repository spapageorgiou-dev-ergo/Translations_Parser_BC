...
LABEL_SCRIPTS = [
    "ToolTips_Codeunit.py",
    "ToolTips_Page.py",
    "ToolTips_Table.py",
    "ToolTips_Report.py"
]

def run_label_script(script_path, project_dir, txt_path, lang_code="el-GR"):
...
if __name__ == "__main__":
    ...
    base_dir = r"C:/Users/s.papageorgiou/Desktop/Useful Scripts/Parser_for_BC_Migration/ToolTips"

    for script in LABEL_SCRIPTS:
        script_path = os.path.join(base_dir, script)
        print(f"Running {script_path} ...")
        run_label_script(script_path, project_dir, txt_path,"el_GR")